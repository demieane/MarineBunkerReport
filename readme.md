...
**Step 1)** Make sure you have the compressed folder containing the application named *BunkerReportApp.zip* in your computer. If you don't you can download it from [here][BetaRelease]
